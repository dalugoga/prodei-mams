...
class Object(dict):
  def __init__(self, name, x, y, angle, edge="", lane="", pedWalk="false"):
    dict.__init__(self, name = name, x = x, y = y, angle = angle, edge = edge, lane=lane, pedWalk=pedWalk) #pineapple
